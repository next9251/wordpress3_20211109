 ...
 <div class="about-firstview">
   <h1 class="about-firstview__catchcopy">
     About
   </h1>
   <svg class="about-firstview__line" xmlns="http://www.w3.org/2000/svg" width="324" height="5" viewBox="0 0 324 5">
     <line id="線_12" data-name="線 12" x2="324" transform="translate(0 2.5)" fill="none" stroke="#000" stroke-width="2" />
   </svg>

   <h2 class="about-firstview__sbtitle">
     新しい教育の常識を作り<br>多くの人々に幸せを届ける。
   </h2>
   <svg class="about-firstview__line2" xmlns="http://www.w3.org/2000/svg" width="324" height="5" viewBox="0 0 324 5">
     <line id="線_12" data-name="線 12" x2="324" transform="translate(0 2.5)" fill="none" stroke="#000" stroke-width="2" />
   </svg>
 </div>

 <div class="about-secview">
   <div>
     <div class="about-secview__content">
 ...
 <div class="about-content">
   ...
   <div class="about-main2">
     <div class="about-main__top">
       ...
       <div class="about-main__box2">
         <h3 class="about-main__title2">
           ０２　オープンなコミュニケーション
         </h3>
         <p class="about-main__cont2">
           組織の成長のためなら、<br>
